...
This system already worked well, but it turned out that changes in computer screen brightness can introduce biases. To compensate for that, the quick calibration was augmented with a highly degraded preview of the next stimulus, just enough to prevent brightness changes between calibration screen and stimulus presentation.
