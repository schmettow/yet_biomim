...
A multilevel linear model was used to analyze the data, with random intercepts for participants and target positions. The dependent variable was the angular error in degrees. The model was fitted using the `brms` package [@brms, version 2.22.0] in R [@Rlang, version 4.5.1].
...
# F_2 <- formula("degree_error ~ 1 + target_x + target_x2 + target_y + target_y2  + 
#                             (1 + target_x + target_x2 + target_y + target_y2|Part)")
...
# FB24_3 <- FB24_2 |> 
#   mutate(Target = as.factor(paste(target_x, target_y, sep = "_"))
# )
# 
# M_3 <- 
# brm(degree_error ~ 1 + (1|Target) + (1|Part),
#                   data = FB24_3,
#                   iter = 20000,
#                   #warmup = 1000,
